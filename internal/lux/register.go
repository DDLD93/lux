// Package lux exists solely to trigger lux's per-site extractor registrations
// (each extractor sub-package registers itself in init()).
package lux
...
import (
	...
	_ "github.com/iawia002/lux/extractors/universal" // provides the fallback "" extractor
